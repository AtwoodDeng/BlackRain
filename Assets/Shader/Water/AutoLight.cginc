...
// 				All added functions have GEOM added to Define function names.
...
// GEOMETRY SHADER
#define TRANSFER_GEOM_SHADOW(a, vert) a._ShadowCoord = mul( unity_WorldToShadow[0], mul( unity_ObjectToWorld, vert ) ); 
...
#define TRANSFER_GEOM_SHADOW(a, vert) a._ShadowCoord = ComputeScreenPos(vert);
...
// GEOMETRY SHADER:
#define TRANSFER_GEOM_SHADOW(a, vert) a._ShadowCoord = mul(unity_ObjectToWorld, vert).xyz - _LightPositionRange.xyz;
...
// GEOMETRY SHADER:
#define TRANSFER_GEOM_SHADOW(a, vert)
...
// GEOMETRY SHADER:
#define TRANSFER_GEOM_TO_FRAGMENT(a, vert)   a._LightCoord = mul(unity_WorldToLight, mul(unity_ObjectToWorld, vert)).xyz; TRANSFER_GEOM_SHADOW(a, vert)
#endif
...
// GEOMETRY SHADER:
#define TRANSFER_GEOM_TO_FRAGMENT(a, vert)   a._LightCoord = mul(unity_WorldToLight, mul(unity_ObjectToWorld, vert)); TRANSFER_GEOM_SHADOW(a, vert)
...
#define LIGHT_ATTENUATION(a)	( (a._LightCoord.z > 0) * UnitySpotCookie(a._LightCoord) * UnitySpotAttenuate(a._LightCoord.xyz) * SHADOW_ATTENUATION(a) )
	...
	// GEOMETRY SHADER:
	#define TRANSFER_GEOM_TO_FRAGMENT(a, vert) TRANSFER_GEOM_SHADOW(a, vert)
#endif
...
// GEOMETRY SHADER:
#define TRANSFER_GEOM_TO_FRAGMENT(a, vert)   a._LightCoord = mul(unity_WorldToLight, mul(unity_ObjectToWorld, vert)).xy; TRANSFER_GEOM_SHADOW(a, vert)
